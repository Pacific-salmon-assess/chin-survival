...
// Based on swallows example but with fixed covariates removed
// Fits time-varying survival and detection probabilities with
// static, random stock effects
